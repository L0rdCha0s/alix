...
## General
1. If we are missing a function in our libc, implement it - never create custom functions in a user app to replace functionality missing in libc - just extend libc where it makes sense.
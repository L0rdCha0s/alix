 ...
 * the mouse driver. `pressed_edge`/`released_edge` indicate left button
 * transitions for the current frame; `left_pressed` is the current state.
 * `right_*` mirrors the right button state for userland routing.

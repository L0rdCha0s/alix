...
// pci_vendors.c
// Table of PCI Vendor IDs -> Vendor Names.
// UTF-8 source. Safe for -Wall -Wextra -pedantic.
// Generated for direct inclusion in a project.
...
static const PciVendor PCI_VENDORS[] = {
...
static const size_t PCI_VENDORS_COUNT = sizeof(PCI_VENDORS) / sizeof(PCI_VENDORS[0]);

// Optional: O(1) linear lookup; replace with binary search if you keep the array sorted by id.
static inline const char *pci_vendor_name(uint16_t id) {
    for (size_t i = 0; i < PCI_VENDORS_COUNT; ++i) {
